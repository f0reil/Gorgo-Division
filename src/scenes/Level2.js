...
export default class Level2 extends Phaser.Scene {
    ...
    create(){
        ...
        this.enemies = [];
        this.enemy = new Enemy(this, 60, 60, this.player);
        ...
        this.door = new Door (this, 350, 20);
        ...
        this.walls_mask = this.make.sprite({
            x: 200,
            y: 200,
            key: 'maskH',
            add: false
        });
        this.walls_mask.setScale(3);
        this.walls_mask.setOrigin(0.5,0.5);
        ...
        //btiles2.mask = new Phaser.Display.Masks.BitmapMask(escena, this.walls_mask );
	...
	update(){
        ...
        this.walls_mask.x = this.player.x;
        this.walls_mask.y = this.player.y;
